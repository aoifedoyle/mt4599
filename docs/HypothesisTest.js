...
class curve {
  ...
  */
  print_population_outside_markers()
  {
    ...
    let x = (this.x_alpha * this.stddev)  / this.step;
    this.ctx.fillText(text, this.xMidpoint+x+50, this.canv_bottom - (this.canv_height/4));  
  }
  ...
  */
  ...
  /* >N
  This updates all the variables that are associated with the stddev of the curve. 
  Called from >M above.
  */
  update_std_vars() 
  {
