...
function paint(){	
	...
	if(showcuml == false) drawPartialCurve(ctx, xvals, yvals, ax - xorigin, bx-xorigin, true, "#000066");
	else{
		if(showFb) drawPartialCurve(ctx, xvals, yvals, 0, bx-xorigin, true,  "#000066");
	...
	var probab = Math.round((probb-proba)*100)/100;//Math.round((jStat.normal.cdf(bxz, 0,1) - jStat.normal.cdf(axz, 0, 1))*1000)/1000;	
